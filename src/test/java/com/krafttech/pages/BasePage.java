...
public abstract class BasePage {
 WebDriver driver;
    ...
    public void navigateToModule(String tab, String module){
        ...
        com.krafttech.utilities.BrowserUtils.waitForClickablility(By.xpath(tabLocator),5);
        WebElement tabElement=driver.findElement(By.xpath(tabLocator));
        tabElement.click();

        com.krafttech.utilities.BrowserUtils.waitForClickablility(By.xpath(moduleLocator),5);
    ...
    public String subTitle(String subTitle){
        ...
        com.krafttech.utilities.BrowserUtils.waitForPresenceOfElement(By.xpath(subTileLocator),5);
